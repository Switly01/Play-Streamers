...
- `downloads/Play-Streamers-Setup.exe`: Play Streamers 0.12.0 Windows kurucusu.
- `release/microsoft-store/Play-Streamers-0.12.0.0-windows-x64.msix`: Windows
  10 2004 ve sonrası için Studio, FFmpeg veya sanal kamera içermeyen Store
  paketi. Paket kimliği `Switly.PlayStreamers`, Store ID değeri
  `9NWZ0TF5K999`'dir.
...
5. Aşağıdaki değişken/secret adlarının Worker ayarlarında bulunduğunu kontrol et.
   ...
   açıklamayı kullanır; analiz akışı çalışmaya devam eder.
...
> Play Streamers 0.12.0 kurucusu birlikte güncellenmelidir. Client secret ve şifreleme
