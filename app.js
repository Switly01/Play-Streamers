(() => {
  ...
  const FX_CACHE_KEY='ps116-exchange-rates'; let exchangeRates=null; try{const cached=JSON.parse(localStorage.getItem(FX_CACHE_KEY)||'null');if(cached?.rates&&Date.now()-Number(cached.savedAt||0)<21600000)exchangeRates=cached}catch{}
