(() => {
  ...
  function completeSignIn(data,{emailMissing=false}={}){landingMode=false;activeUserSession=data.sessionId||activeUserSession;adoptAuthenticatedUser(data.user);state.settings.userSession=activeUserSession;save();removeLandingAuth();render();refreshInterfaceLanguage();if(emailMissing)showEmailMissingNotice()}
