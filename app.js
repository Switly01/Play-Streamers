(() => {
  ...
  function completeSignIn(data,{emailMissing=false}={}){landingMode=false;activeUserSession=data.sessionId||activeUserSession;state.settings.userSession=activeUserSession;adoptAuthenticatedUser(data.user);save();removeLandingAuth();render();if(emailMissing)showEmailMissingNotice()}
