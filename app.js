  ...
  async function configure() {
    try {
      ...
      state.widgetId = window.turnstile.render(host, {
        ...
        theme: 'dark',
        // `invisible` is a widget mode selected in the Cloudflare dashboard,
