...
const CURRENT_RELEASE_VERSION = "7.7";
const CURRENT_RELEASE_PUBLISHED_AT = "2026-09-01T17:05:00+03:00";
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (url.pathname === "/api/auth/session" && request.method === "GET") {
        ...
        return withSessionCookies(apiResponse(request, {
          signedIn: true,
          user,
          plan,
...
async function runScheduledPlayBotAudit(env) {
  ...
  const resources = [
    ...
    ["Uygulama betiği", "https://pstreamers.com/app-final.js?v=5.21.1", "script"],
    ["Site davranış betiği", "https://pstreamers.com/site-v7.js?v=10.18.0", "script"],
    ...
    ["Premium stil dosyası", "https://pstreamers.com/site-v7.css?v=10.24.0", "style"],
  ...
  if (homeDocument?.ok) {
    const documentContracts = [
      ["site-v7.css?v=10.24.0", "Güncel premium stil dosyası"],
      ["app.js?v=5.8.0", "Güncel ana uygulama betiği"],
      ["app-final.js?v=5.21.1", "Güncel onarım betiği"],
      ["site-v7.js?v=10.18.0", "Güncel site davranış betiği"],
      ["live-i18n.js?v=10.3.0", "Güncel sabit paket çeviri betiği"],
      ["play-streamers-build\" content=\"2026-09-01-site-10.24.0", "Site 10.24.0 sürüm işareti"],
    ];
