...
async function runScheduledPlayBotAudit(env) {
  ...
  const resources = [
    ...
    ["Site davranış betiği", "https://pstreamers.com/site-v7.js?v=10.5.3", "script"],
    ["Canlı çeviri betiği", "https://pstreamers.com/live-i18n.js?v=8.2", "script"],
    ["Premium stil dosyası", "https://pstreamers.com/site-v7.css?v=10.5.3", "style"],
  ...
  if (homeDocument?.ok) {
    const documentContracts = [
      ["site-v7.css?v=10.5.3", "Güncel premium stil dosyası"],
      ["app.js?v=5.4.0", "Güncel ana uygulama betiği"],
      ["app-final.js?v=5.9.3", "Güncel onarım betiği"],
      ["site-v7.js?v=10.5.3", "Güncel site davranış betiği"],
      ["live-i18n.js?v=8.2", "Güncel canlı çeviri betiği"],
      ["play-streamers-build\" content=\"2026-08-27-site-10.5.3", "Site 10.5.3 sürüm işareti"],
    ];
