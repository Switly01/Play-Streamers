...
const CURRENT_RELEASE_VERSION = "5.8";
const CURRENT_RELEASE_PUBLISHED_AT = "2026-08-29T00:54:38+03:00";
...
async function runScheduledPlayBotAudit(env) {
  ...
  const resources = [
    ...
    ["Ana uygulama betiği", "https://pstreamers.com/app.js?v=5.4.4", "script"],
    ["Uygulama betiği", "https://pstreamers.com/app-final.js?v=5.9.6", "script"],
    ["Site davranış betiği", "https://pstreamers.com/site-v7.js?v=10.9.0", "script"],
    ["Canlı çeviri betiği", "https://pstreamers.com/live-i18n.js?v=9.1.0", "script"],
    ["İngilizce dil paketi", "https://pstreamers.com/locales/en.json?v=2026-08-29.1", "json"],
    ["Almanca dil paketi", "https://pstreamers.com/locales/de.json?v=2026-08-29.1", "json"],
    ["İspanyolca dil paketi", "https://pstreamers.com/locales/es.json?v=2026-08-29.1", "json"],
    ["Fransızca dil paketi", "https://pstreamers.com/locales/fr.json?v=2026-08-29.1", "json"],
    ["Rusça dil paketi", "https://pstreamers.com/locales/ru.json?v=2026-08-29.1", "json"],
    ["Arapça dil paketi", "https://pstreamers.com/locales/ar.json?v=2026-08-29.1", "json"],
    ["Japonca dil paketi", "https://pstreamers.com/locales/ja.json?v=2026-08-29.1", "json"],
    ["Premium stil dosyası", "https://pstreamers.com/site-v7.css?v=10.9.0", "style"],
    ...
    ["PS marka amblemi", "https://pstreamers.com/play-streamers-ps-logo.svg?v=10.8", "image"],
  ...
  for (const result of results) {
    ...
    if (result.type === "json") {
      ...
      const validPayload = result.label === "Windows güncelleme bildirimi"
        ...
        : localeCatalog
          ? Boolean(payload?.version === "2026-08-29.1" && payload?.sourceLanguage === "tr" && payload?.language && Object.keys(payload?.translations || {}).length >= 350)
          : Boolean(payload?.ok);
  ...
  if (homeDocument?.ok) {
    const documentContracts = [
      ["site-v7.css?v=10.9.0", "Güncel premium stil dosyası"],
      ["app.js?v=5.4.4", "Güncel ana uygulama betiği"],
      ["app-final.js?v=5.9.6", "Güncel onarım betiği"],
      ["site-v7.js?v=10.9.0", "Güncel site davranış betiği"],
      ["live-i18n.js?v=9.1.0", "Güncel sabit paket çeviri betiği"],
      ["play-streamers-build\" content=\"2026-08-29-site-10.9.0", "Site 10.9.0 sürüm işareti"],
    ];
