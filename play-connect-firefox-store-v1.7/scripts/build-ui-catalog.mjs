...
fs.writeFileSync(path.join(root,'src','ui-catalog.json'),JSON.stringify(catalog));
console.log(`Play Connect arayüz kataloğu güncellendi: ${catalog.sources.length} kaynak metin.`);
