...
private: 
    bool _EnsureSharedFrameMapping();
    bool _CopySharedFrame(
        _Inout_updates_bytes_(len) BYTE* pBuf,
        _In_ DWORD len,
        _In_ LONG pitch,
        _In_ DWORD width,
    ...
    HANDLE m_sharedFrameMapping = nullptr;
    const BYTE* m_sharedFrameView = nullptr;
    ULONGLONG m_lastMappingAttempt = 0;
