...
export const FEATURES: FeatureDefinition[] = [
  ...
  { id: "data-export", title: "CSV dışa aktarma", description: "Tamamlanmış ve doğrulanmış yayınları tablo uygulamalarına uygun CSV olarak dışa aktarır.", section: "analysis", minimumTier: "pro", status: "ready" },
  ...
  { id: "overlay-studio", title: "Görsel yayın tasarımcısı", description: "Başlık ve etiket görsellerini marka rengiyle düzenleyip şeffaf HTML overlay olarak dışa aktarır.", section: "brand", minimumTier: "pro", status: "ready", localFirst: true },
  ...
  { id: "emote-badge-studio", title: "Emote ve rozet tasarımcısı", description: "Renk ve kısa işaretten 112, 56 ve 28 piksel PNG rozetler üretir.", section: "brand", minimumTier: "product-pro", status: "ready", localFirst: true },
  ...
  { id: "snapshots", title: "Çalışma alanı anlık görüntüsü", description: "Araç ve tema ayarlarını oturum bilgisi içermeyen geri yüklenebilir dosya olarak saklar.", section: "vault", minimumTier: "product-pro", status: "ready", localFirst: true },
  ...
  { id: "layouts", title: "Çalışma alanı düzenleri", description: "Araç ve tema tercihlerini adlandırılmış yerel profiller olarak kaydedip uygular.", section: "settings", minimumTier: "pro", status: "ready", localFirst: true },
