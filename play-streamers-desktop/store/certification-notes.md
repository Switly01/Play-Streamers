# Microsoft Store certification notes — 0.14.4

Play Streamers 0.14.4 is a packaged Tauri-based Win32 creator workspace. It connects to `https://api.pstreamers.com` and SW Identity over HTTPS. Test on Windows 10 version 2004 (build 19041) or later, or Windows 11, as a standard user. Administrator privileges are not required.
