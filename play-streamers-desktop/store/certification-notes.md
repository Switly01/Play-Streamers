# Microsoft Store certification notes — 0.14.3

Play Streamers 0.14.3 is a packaged Tauri-based Win32 creator workspace. It connects to `https://api.pstreamers.com` and SW Identity over HTTPS. Test on Windows 10 version 2004 (build 19041) or later, or Windows 11, as a standard user. Administrator privileges are not required.
...
The final `0.14.3.0` x64 MSIX was tested with Windows App Certification Kit
10.0.26100.7705 on Windows 11. The complete command-line run finished with
`OVERALL_RESULT="PASS"`; the report is stored as `WACK-0.14.3.0.xml`. The
package SHA-256 is
`F32B3D1D55A632D4B036A9C17DA607E4A54C6ABD44BF7D870E3A472A85A793C9`.
