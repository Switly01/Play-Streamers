...
if(url.pathname.includes('/api/kick/events'))data={ok:true,broadcasterId:'qa-kick',insights:{...qaState.settings.kickInsights,activeFollowers:27,activeSubscribers:2,followedThisMonth:9,hourlyMetrics:[{hour:'06',followersCount:27},{hour:'07',followersCount:null}]},events:[]};
